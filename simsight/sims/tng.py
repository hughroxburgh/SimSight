...
class TNG_SightlineSim():
    def __init__(self,data_path,fsps_path=None):
        ...
        self.figm = 0.8195   #0.85 Martizzi+2019, but not super accurate
        self.fgas = 0.5 # kinda place holder
    ...
    def _get_redshifts(self):
        ...
        self.redshifts = np.array([0, 9.52166697e-03, 2.39744284e-02, 3.37243719e-02,
                                ...
                                1.09756433e+01, 1.19802133e+01, 1.49891732e+01, 2.00464910e+01]).astype(np.float32)
    ...
    def load_data(self, particle_type, fields, snapNum,method='custom',verbose=True):
